...
class InsultServer:
    ...
    def add_text(self, text):
        self.insultList.append(text)
        print("Text added.")

        for subscriber in self.subscribers:
            try:
                proxy = xmlrpc.client.ServerProxy(subscriber)
                proxy.notify(text)
            except Exception as e:
                print(f"Failed to notify {subscriber}: {e}")

        return "Text added and subscribers notified."

    def get_insult(self):
        return self.filter_insult(random.choice(self.insultList))
    ...
    def add_subscriber(self, subscriber):
        if subscriber not in self.subscribers:
            ...
            print(f"Subscriber {subscriber} added.")
